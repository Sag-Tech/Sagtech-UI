const buttonConst = {
  ...
  tabButtonBase:
    'leading-24 flex justify-center items-center gap-8px text-14  px-16px py-7px rounded-[50px] transition-all duration-800',
  tabButtonDefault:
    'text-grey_4  border-[1px] border-solid border-grey_4 rounded-[50px] transition-all duration-800',
  tabButtonActive:
    'bg-pr_purple border-[1px] border-solid border-pr_purple text-white_4',
  tabButtonDisabled:
  ...
  hoverAnimation: 'hover:shadow-3xl',
  ...
  tabButtonHover:
    'hover:border-white_4 hover:text-white_4 hover:transition-all hover:duration-800',
